...
const maleStudentsTable = document.getElementById("male-students");
const femaleStudentsTable = document.getElementById("female-students");
...
// Button click events for sorting
...
document.getElementById("sortByGender").addEventListener("click", () => {
    ...
    maleStudentsTable.innerHTML = '';
    femaleStudentsTable.innerHTML = '';

    renderStudentTable(maleStudents);
    renderStudentTable(femaleStudents);

    maleStudentsTable.classList.remove("hidden");
    femaleStudentsTable.classList.remove("hidden");
});
